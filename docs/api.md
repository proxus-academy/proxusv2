...
El workspace contiene usuarios UGC, campañas, grupos, membresías, reuniones, vídeos, capturas históricas de métricas, pagos y —solo para los actores autorizados— configuraciones versionadas del programa por mercado. Los pagos identifican destinatario, creador relacionado, origen idempotente, moneda y tipo; permiten representar compensaciones de trial y campaña junto con incentivos de managers. La visibilidad del manager queda limitada a sus mercados, leads o solicitudes gestionadas y grupos asignados; un creador solo recibe sus propios datos y las reuniones que puede reservar. Las acciones administrativas exigen rol global de administrador en el servidor, independientemente de lo que muestre el cliente.
