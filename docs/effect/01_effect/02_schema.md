> Portado de [`Effect-TS/effect/ai-docs/src/01_effect/02_schema`](https://github.com/Effect-TS/effect/tree/b49284193f86737e411dc3dd19cfb1a8b9fa5d95/ai-docs/src/01_effect/02_schema) en el commit `b49284193f86737e411dc3dd19cfb1a8b9fa5d95` (licencia MIT).
...
For a comprehensive guide, see [packages/effect/SCHEMA.md](https://github.com/Effect-TS/effect/blob/b49284193f86737e411dc3dd19cfb1a8b9fa5d95/packages/effect/SCHEMA.md). Make sure to read the guide in chunks, as it is a large document.

## Schema basics

Source: `01_effect/02_schema/10_schema-basics.ts`.
