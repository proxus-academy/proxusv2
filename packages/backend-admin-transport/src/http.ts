...
import { AdminUgcHandlers } from "./modules/ugc-management/http.js"

export const makeAdminApiRoutes = (openapiPath: `/${string}` = "/openapi.json") => HttpApiBuilder.layer(AdminApi, {
  openapiPath,
}).pipe(Layer.provide(Layer.mergeAll(AdminStudyCatalogHandlers, AdminAccessControlHandlers, AdminUsersHandlers, AdminUgcHandlers)))
