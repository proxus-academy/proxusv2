...
type ResourceCatalogContract<Value> = Value extends string
  ? string
  : { readonly [Key in keyof Value]: ResourceCatalogContract<Value[Key]> }
...
} satisfies ResourceCatalogContract<typeof es>
