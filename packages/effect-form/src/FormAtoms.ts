  ...
  if (Option.isNone(state)) {
    throw new Error(
      `Field "${fieldPath}" was read before the form was initialized. ` +
        ...
        "the Provider returned by your renderer binding, or set the form state before reading field atoms. " +
            ...
            return yield* Effect.die(
              new Error(
                "submit was called before the form was initialized — mount " +
                  "the Provider returned by your renderer binding before submitting. " +
                  `See the "Basic Form Setup" section of the README.`
              )
            )
          }
