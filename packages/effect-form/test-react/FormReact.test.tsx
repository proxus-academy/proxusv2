...
describe("FormReact.make", () => {
  describe("Initialize Component", () => {
    it("initializes with default values", () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: TextInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit
      }))

      render(
        <form.Provider defaultValues={{ name: "John" }}>
          <form.name />
        </form.Provider>
      )
  ...
  describe("Field Component", () => {
    it("updates value on change", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "" }}>
          <form.name />
        </form.Provider>
      )
  ...
  describe("isDirty atom", () => {
    it("returns isDirty = false when values match initial", () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "test" }}>
          <form.name />
          <TestComponent />
        </form.Provider>
      )
    ...
    it("submit calls onSubmit with decoded values", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: TextInput, age: NumberFromStringInput } }), neutralForm))(Form.make(formBuilder, {
      ...
      render(
        <form.Provider defaultValues={{ name: "John", age: "42" }}>
          <form.name />
          <form.age />
          <SubmitButton />
        </form.Provider>
  ...
  describe("multiple fields", () => {
    it("renders multiple fields correctly", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: {
          firstName: FirstNameInput,
          lastName: LastNameInput
        } }), neutralForm))(Form.make(formBuilder, {
        onSubmit
      }))

      render(
        <form.Provider defaultValues={{ firstName: "", lastName: "" }}>
          <form.firstName />
          <form.lastName />
        </form.Provider>
      )
  ...
  describe("array fields", () => {
    ...
    it("throws a descriptive error when array field renders outside Provider", () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { items: { name: ItemNameInput } } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: () => {}
      }))
    ...
    it("renders array item subfields when item schema uses filterEffect", async () => {
      ...
      render(
        <form.Provider defaultValues={{ items: [{ name: "First" }] }}>
          <form.items>
            {({ items }) => (
              <>
                {items.map((_, i) => (
  ...
  describe("field path", () => {
    it("exposes the field key as path for top-level fields", () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: PathInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: () => {}
      }))
    ...
    it("exposes the correct nested path for fields inside array items", () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { items: { name: ItemPathInput } } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: () => {}
      }))

      render(
        <form.Provider defaultValues={{ items: [{ name: "A" }, { name: "B" }] }}>
          <form.items>
            {({ items }) => (
              <>
                {items.map((_, i) => (
  ...
  describe("async validation", () => {
    it("submit works with async schema validation (filterEffect)", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { email: TextInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: (_: void, { decoded }) => submitHandler(decoded)
      }))
      ...
      render(
        <form.Provider defaultValues={{ email: "test@example.com" }}>
          <form.email />
          <SubmitButton />
        </form.Provider>
      )
    ...
    it("exposes isValidating state during async validation", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { asyncField: ValidatingInput } }), neutralForm))(Form.make(formBuilder, {
        mode: { validation: "onBlur" },
        onSubmit
      }))

      render(
        <form.Provider defaultValues={{ asyncField: "" }}>
          <form.asyncField />
        </form.Provider>
      )
  ...
  describe("cross-field validation", () => {
    it("FormBuilder.refine validates across fields and routes error to specific field", async () => {
      ...
      render(
        <form.Provider defaultValues={{ password: "secret", confirmPassword: "different" }}>
          <form.password />
    ...
    it("refineEffect performs async cross-field validation", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { username: UsernameInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit
      }))
      ...
      render(
        <form.Provider defaultValues={{ username: "taken" }}>
          <form.username />
          <SubmitButton />
        </form.Provider>
      )
    ...
    it("multiple chained refine() calls are all executed", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { fieldA: FieldAInput, fieldB: FieldBInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit
      }))
      ...
      const { rerender } = render(
        <form.Provider key="1" defaultValues={{ fieldA: "error1", fieldB: "valid" }}>
          <form.fieldA />
          <form.fieldB />
          <SubmitButton />
        </form.Provider>
      ...
      rerender(
        <form.Provider key="2" defaultValues={{ fieldA: "valid", fieldB: "error2" }}>
          <form.fieldA />
          <form.fieldB />
          <SubmitButton />
        </form.Provider>
    ...
    it("cross-field error persists when typing after failed submit (still invalid)", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { password: PasswordInput, confirm: ConfirmInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit
      }))
      ...
      render(
        <form.Provider defaultValues={{ password: "secret", confirm: "different" }}>
          <form.password />
          <form.confirm />
          <SubmitButton />
        </form.Provider>
    ...
    it("routes cross-field errors to nested array item fields", async () => {
      ...
      render(
        <form.Provider defaultValues={{ items: [{ name: "AB" }] }}>
          <form.items>
            {({ items }) => (
              <>
                {items.map((_, i) => (
  ...
  describe("validation modes", () => {
    ...
    it("onSubmit mode keeps errors when typing still-invalid values after failed submit", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { password: TextInput } }), neutralForm))(Form.make(formBuilder, {
        mode: { validation: "onSubmit" },
        onSubmit: () => {}
      }))
      ...
      render(
        <form.Provider defaultValues={{ password: "" }}>
          <form.password />
          <SubmitButton />
        </form.Provider>
      )
    ...
    it("cross-field refinement errors persist until re-submit", async () => {
      ...
      render(
        <form.Provider defaultValues={{ password: "test", confirm: "different" }}>
          <form.password />
          <form.confirm />
          <SubmitButton />
        </form.Provider>
    ...
    it("per-field errors clear on valid input while refinement errors persist", async () => {
      ...
      render(
        <form.Provider defaultValues={{ password: "short", confirm: "different" }}>
          <form.password />
          <form.confirm />
          <SubmitButton />
        </form.Provider>
    ...
    it("hides stored field error while async validation is pending (async gap)", async () => {
      ...
      render(
        <form.Provider defaultValues={{ password: "short" }}>
          <form.password />
          <SubmitButton />
        </form.Provider>
      )
    ...
    it("persists refinement errors across field unmount/remount", async () => {
      ...
      const ToggleableForm = () => {
        ...
        return (
          <form.Provider defaultValues={{ password: "abc", confirm: "xyz" }}>
            <form.password />
  ...
  describe("form atoms", () => {
    ...
    it("updates isDirty when values change", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "initial" }}>
          <form.name />
          <Consumer />
        </form.Provider>
      )
  ...
  describe("isDirty lifecycle", () => {
    it("form does not reinitialize on rerender (mount-only initialization)", async () => {
      ...
      const FormWrapper = ({ defaultName }: { defaultName: string }) => (
        <form.Provider defaultValues={{ name: defaultName }}>
          <form.name />
          <TestComponent />
        </form.Provider>
      )
    ...
    it("form reinitializes when using React key to force remount", async () => {
      ...
      const FormWrapper = ({ defaultName, formKey }: { defaultName: string; formKey: string }) => (
        <form.Provider key={formKey} defaultValues={{ name: defaultName }}>
          <form.name />
          <TestComponent />
        </form.Provider>
      )
    ...
    it("key-change remount with parent subscription does not render stale values", async () => {
      ...
      const Parent = ({ defaultName, variantId }: { variantId: string; defaultName: string }) => {
        ...
        return (
          <form.Provider key={variantId} defaultValues={{ name: defaultName }}>
            <form.name />
            <ValueTracker />
          </form.Provider>
        )
  ...
  describe("runtime optionality", () => {
    it("does not require runtime when R is only AtomRegistry", () => {
      ...
      expectTypeOf(form.Provider).not.toBeAny()
    })
  })
  ...
  describe("debounce and auto-submit", () => {
    ...
    it("debounces validation updates in onChange mode", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: DebounceTextInput } }), neutralForm))(Form.make(formBuilder, {
      ...
      render(
        <form.Provider defaultValues={{ name: "Valid" }}>
          <form.name />
        </form.Provider>
      )
    ...
    it("batches updates from multiple fields into a single auto-submission", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: NameInput, age: AgeInput } }), neutralForm))(Form.make(formBuilder, {
        runtime: createRuntime(),
        mode: { validation: "onChange", debounce: "100 millis", autoSubmit: true },
        onSubmit: (_: void, { decoded }) => submitHandler(decoded)
      }))
      ...
      render(
        <form.Provider defaultValues={{ name: "", age: "" }}>
          <form.name />
          <form.age />
        </form.Provider>
      )
  ...
  describe("validate", () => {
    it("shows field errors immediately with validateOnInit + invalid defaults", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "ab" }} validateOnInit>
          <form.name />
          <SubmitCountDisplay />
        </form.Provider>
      )
    ...
    it("shows no errors with validateOnInit + valid defaults", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "Valid Name" }} validateOnInit>
          <form.name />
        </form.Provider>
      )
    ...
    it("shows refinement errors with validateOnInit", async () => {
      ...
      render(
        <form.Provider defaultValues={{ password: "secret", confirm: "different" }} validateOnInit>
          <form.password />
          <form.confirm />
        </form.Provider>
      )
    ...
    it("imperative validate shows errors after programmatic setValues", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "Valid Name" }}>
          <form.name />
          <Controls />
        </form.Provider>
      )
  ...
  describe("per-field validate", () => {
    it("shows error for that field only in onSubmit mode", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: NameInput, email: EmailInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: () => {}
      }))
      ...
      render(
        <form.Provider defaultValues={{ name: "ab", email: "cd" }}>
          <form.name />
          <form.email />
          <ValidateName />
        </form.Provider>
    ...
    it("works in onBlur mode", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "ab" }}>
          <form.name />
          <ValidateName />
        </form.Provider>
      )
    ...
    it("multiple fields can be validated independently", async () => {
      ...
      const form = ((neutralForm) => Object.assign(FormReact.make(neutralForm, { fields: { name: NameInput, email: EmailInput, age: AgeInput } }), neutralForm))(Form.make(formBuilder, {
        onSubmit: () => {}
      }))
      ...
      render(
        <form.Provider defaultValues={{ name: "ab", email: "cd", age: "1" }}>
          <form.name />
          <form.email />
          <form.age />
          <Controls />
  ...
  describe("rootError atom", () => {
    it("exposes root-level refinement errors through form.rootError", async () => {
      ...
      render(
        <form.Provider defaultValues={{ name: "invalid" }}>
          <form.name />
          <RootError />
          <SubmitButton />
        </form.Provider>
